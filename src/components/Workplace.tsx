...
export function Workplace() {
  ...
  if (!user) {
    return (
      <div className="p-6">
        <h2 className="text-3xl font-bold text-foreground mb-4">Workplace</h2>
        <div className="bg-warning/10 border border-warning text-foreground p-4 rounded-lg">
          Please sign in to manage your workplace settings.
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-foreground">Workplace</h2>
        <p className="text-muted-foreground">Manage your addresses and payment methods for openings</p>
      </div>
      ...
      <Tabs defaultValue="addresses">
        ...
        <TabsContent value="addresses" className="space-y-4">
          ...
          {loadingAddresses ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {addresses.map((addr) => (
                <Card key={addr.id} className="shadow-soft border-card-border">
        ...
        <TabsContent value="payments" className="space-y-4">
          ...
          {loadingPayments ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {payments.map((pm) => (
                <Card key={pm.id} className="shadow-soft border-card-border">
                  <CardContent className="pt-6">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 pt-4">
            <div className="space-y-2">
              <Label>Label</Label>
              <Input
                placeholder="e.g. Business Visa, Cash on site"
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="e.g. ending in 4242, account info"
