...
const compositionId = "pikappoint-demo";

console.log("🎬 Starting Remotion render for PikAppoint Demo...");
...
const outputLocation = path.resolve(__dirname, "../videos/pikappoint-demo.mp4");
